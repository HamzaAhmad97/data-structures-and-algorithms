...
const updateAnimal = (arr, callback) => arr.map(itm => callback(itm));
...
const sortNames = arr => arr.sort((a,b) => a > b ? 1 : b > a ? -1 : 0 );
...
const sortNumbers = (arr) => arr.sort((a,b) => Number(a) < Number(b) ? -1 : Number(a) > Number(b) ? 1 : 0);
...
const sortBackwards = (arr) => arr.sort((a,b) => Number(a) < Number(b) ? 1 : Number(a) > Number(b) ? -1 : 0);
...
const alphabetize = (arr) => arr.sort((a,b) => a > b ? 1 : b > a ? -1 : 0 );
