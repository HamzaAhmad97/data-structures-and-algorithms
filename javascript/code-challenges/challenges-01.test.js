...
const addOne = (arr) => {
  // Solution code here...
  let temp = [];
  arr.forEach(item => temp.push(item + 1));
  return temp;
};
...
const allUpperCase = (arr) => {
  // Solution code here...
  let temp = [];
  arr.forEach(item => temp.push(item.toUpperCase()));
  return temp;
};
...
const speaker = (words, callback) => {
  // Solution code here...
  let temp = [];
  words.forEach(item => temp.push(callback(item)));
  return temp;
};
...
const createList = (availableItems) => {
  ...
  availableItems.forEach(item => {
    item.available ? list.push(item.name) : item ;
  });
  return list;
};
...
const fizzbuzz = (arr) => {
  ...
  let temp = [];
  arr.forEach(item => {
    item % 3 === 0 && item % 5 ===0 ? temp.push('Fizz Buzz') : item % 3 === 0 ? temp.push('Fizz') : item % 5 === 0 ? temp.push('Buzz') : temp.push(item);
  });
  return temp;
};
