...
const listFoods = (recipe) => recipe.map(itm => itm.slice(itm.lastIndexOf(itm.match(/pounds|pound|gallons|cups|sized/))+String(itm.match(/pounds|pound|gallons|cups|sized/)).length+1));
